...
Если с верхнем проблемы (их быть не должно) можете попробовать этот билд - https://github.com/spacecollapse/alkad-eac-bypass/releases/download/rust/EacBypass.exe
