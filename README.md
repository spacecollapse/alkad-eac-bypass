...
Точно такая же версия через другой компилятор (если вам не нравится либо есть проблемы с верхней(их быть не должно) - https://github.com/spacecollapse/alkad-eac-bypass/releases/download/rust/EacBypass.exe
